 ...
 * @author LENOVO
 */
public class CardYoussefController implements Initializable {
...
//    }
    ...
    public void addBtn(){
        ...
        if (qty==0){
            ...
            String insertData="Insert Into  commandeyoussef (nom,quantite_commande,prix,date_commande)"
                    +"VALUES(?,?,?,?)";
            try {
