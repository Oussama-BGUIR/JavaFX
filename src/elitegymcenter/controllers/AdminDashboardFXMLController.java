...
import elitegymcenter.controllers.Planning.PlanningController;
...
import elitegymcenter.services.ServiceUtilisateurIMP;
import elitegymcenter.utils.MailTools;
...
//        }
    ...
    private void GoToStatistic(ActionEvent event) {
           try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/elitegymcenter/gui/statfxml.fxml"));
    ...
    private void logout(ActionEvent event) {
          try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/elitegymcenter/gui/loginfxml.fxml"));
            Parent root = loader.load();
            tf_prenom.getScene().setRoot(root);
        } catch (IOException ex) {
              System.out.println(ex.getMessage());
    ...
    private void exportToCsv(ActionEvent event) {
     ...
     @FXML
    private void ProduitsBTN(ActionEvent event) 
    {
         try {
       ...
       @FXML
    private void voirRestaurant_Admin(ActionEvent event) 
    {
         try {
          ...
          @FXML
    private void AdminRdv(ActionEvent event) 
    {
         try {
     ...
     @FXML
    private void AbonnementBTN_admin(ActionEvent event) 
    {
         try {

            Parent page1= FXMLLoader.load(getClass().getResource("../gui/Abonnement/AfficherAbonnementBack.fxml"));
            Scene scene = new Scene(page1);
            Stage stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
            stage.setScene(scene);
            stage.show();
        ...
        @FXML
    private void go_planning(ActionEvent event) 
    {
         try {
