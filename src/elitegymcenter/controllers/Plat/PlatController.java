...
public class PlatController implements Initializable {
    ...
    static String nom,description ,image;
       ...
       @FXML
    private TableView<Plat> AffichageListePlatsBackfx;

    @FXML
    private TableColumn<Plat, Integer> caloriefx;

    @FXML
    private ImageView code_qr;

    @FXML
    private TableColumn<Plat, String> descriptionfx;

    @FXML
    private TableColumn<Plat, Boolean> disponibiltefx;

    @FXML
    private TableColumn<Plat, Integer> idfx;

    @FXML
    private TableColumn<Plat, String> imagefx;

    @FXML
    private TableColumn<Plat, Integer> menu_idfx;

    @FXML
    private TableColumn<Plat, String> nomfx;

    @FXML
    private TableColumn<Plat, Integer> prixfx;
    ...
    List<Plat> list = inter.afficherPlat();
    ObservableList<Plat> observableList = FXCollections.observableArrayList(list);
    AffichageListePlatsBackfx.setItems(observableList);
    ...
    disponibiltefx.setCellValueFactory(new PropertyValueFactory<>("disponibilte"));
    ...
    menu_idfx.setCellValueFactory(new PropertyValueFactory<>("menu_id"));
   ...
   // trnom.setOnAction(e -> trierParNom());
      ...
      private void trierParNom() {
          ObservableList<Plat> plats = AffichageListePlatsBackfx.getItems();
          ...
          AffichageListePlatsBackfx.refresh();
      }
    ...
    private void modifierPlatBack(ActionEvent event) {
        ...
        TableView<Plat> list = AffichageListePlatsBackfx;
        PlatCRUD inter = new ServicePlatCRUD();
    ...
    */
       ...
       private void supprimerPlatBack(ActionEvent event) {
           ...
           TableView<Plat> list = (TableView<Plat>) AffichageListePlatsBackfx;
           PlatCRUD inter = new ServicePlatCRUD();
    ...
    {
        Plat p = AffichageListePlatsBackfx.getSelectionModel().getSelectedItem();
        ...
        private void recherchefiltrePlat() {
            ...
            AffichageListePlatsBackfx.setItems(platss);
        }
