 ...
 */
package elitegymcenter.controllers.Offre;

import elitegymcenter.controllers.Abonnement.AfficherAbonnementBackController;
import elitegymcenter.entities.Offre;
import elitegymcenter.interfaces.OffreCRUD;
import elitegymcenter.services.Offre1CRUD;
...
public class AfficherOffreController implements Initializable {
    ...
    private void modifierOffre(ActionEvent event) 
    {
       ...
       System.out.println(E.getId());
        ...
        try {
            ...
            Parent page1= FXMLLoader.load(getClass().getResource("/elitegymcenter/gui/Offre/modifierOffre.fxml"));
    ...
    private void AjouterOffre(ActionEvent event) 
    {
        try {
            ...
            Parent page1= FXMLLoader.load(getClass().getResource("/elitegymcenter/gui/Offre/AjoutOffre.fxml"));
            Scene scene = new Scene(page1);
            Stage stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
            stage.setScene(scene);
            stage.show();
    ...
    private void SearchFilter() {
     ...
     @FXML
    private void retourAdminOffre(ActionEvent event) 
    {
