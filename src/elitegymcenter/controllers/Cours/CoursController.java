...
import static com.stripe.model.Charge.list;
...
public class CoursController implements Initializable {
	 ...
	 @FXML
	    ...
	    @FXML
	    private TableColumn<Cours, Integer> plan;
	    @FXML
	    private TableColumn<Cours, LocalDateTime> date;
	    @FXML
...
image.setCellFactory(cellFactoryImage);
    ...
    private void modifierCoursBack(ActionEvent event) {
         ...
         TableView<Cours> list = tableView;
       ...
       Cours c = list.getSelectionModel().getSelectedItem();
        ...
        String nom1 = c.getNom();
        LocalDateTime duree = c.getDuree();
        String salle1 = c.getSalle();
        int planningId = c.getPlanningId();
   ...
   tableView.refresh();
    ...
    private void stat(ActionEvent event) 
    {
         try {
            ...
            Parent page1= FXMLLoader.load(getClass().getResource("../../gui/Cours/chart.fxml"));
            Scene scene = new Scene(page1);
            Stage stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
            stage.setScene(scene);
            stage.show();
