    ...
    */
    ...
    public void initialize(URL url, ResourceBundle rb) {
      // TODO
        ...
        planningidfx.setText(String.valueOf(CoursController.C.getPlanning_id()));
    ...
    private void modifiercours(ActionEvent event) 
    {
        ...
        Cours C1 = new Cours(CoursController.C.getId(),CoursController.C.getPlanning_id(),nom, duree, salle );
