...
public class LoginfxmlController implements Initializable {
   ...
   private void GoToSignUp(ActionEvent event) {
          try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/elitegymcenter/gui/signupfxml.fxml"));
   ...
   private void GoToAdminDashboard(ActionEvent event) {
          try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/elitegymcenter/gui/AdminDashboardFXML.fxml"));
            Parent root = loader.load();
            tf_email.getScene().setRoot(root);
        } catch (IOException ex) {
            System.out.println(ex.getMessage());
   ...
   private void GoToUser(ActionEvent event) {
          try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/elitegymcenter/gui/BIENVENUE.fxml"));
            Parent root = loader.load();
            tf_email.getScene().setRoot(root);
        } catch (IOException ex) {
            System.out.println(ex.getMessage());
   ...
   private void RestPassword(ActionEvent event) {
         if (null != su.FindByEmail(tf_email.getText())) {
            ...
            try {
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/elitegymcenter/gui/ModifierPasswordClient.fxml"));
                Parent root = loader.load();
                tf_email.getScene().setRoot(root);
            } catch (IOException ex) {
                System.out.println(ex.getMessage());
